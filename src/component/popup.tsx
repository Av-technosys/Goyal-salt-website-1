    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      >
        ...
        <button
          ...
          className="
            absolute right-2.5 top-2.5 sm:right-4 sm:top-4 z-50
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 relative">
          ...
          ">
            ...
            {/* Top Floating Badge */}
            <div className="self-start mb-1 sm:mb-3">
              <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 sm:px-3 sm:py-1 rounded-full bg-white/90 backdrop-blur-md border border-red-200/80 text-red-700 text-[10px] sm:text-[11px] font-bold shadow-2xs">
            ...
            {/* Product Range Image */}
            <div className="relative w-full h-[110px] sm:h-[190px] md:h-[240px] my-0.5 flex items-center justify-center transition-transform duration-500 hover:scale-105">
              <Image
            ...
            <div className="mt-1 sm:mt-2 text-center">
              <span className="inline-flex items-center gap-1 px-2.5 py-0.5 sm:px-3 sm:py-1 rounded-full bg-gray-950/85 backdrop-blur-md text-amber-300 text-[9.5px] sm:text-[11px] font-semibold shadow-xs">
          ...
          ">
            <div>
              {/* Category Pill Badge */}
              <div className="inline-flex items-center gap-1.5 px-3 py-0.5 sm:px-3.5 sm:py-1 rounded-full bg-red-50 border border-red-200 text-red-600 text-[10.5px] sm:text-xs font-extrabold uppercase tracking-wider mb-2 sm:mb-3 shadow-2xs">
                <TrendingUp className="w-3 h-3 sm:w-3.5 sm:h-3.5 animate-pulse" />
                <span>DISTRIBUTORSHIP</span>
              </div>

              {/* Main Heading */}
              <h2 className="text-xl sm:text-3xl md:text-[28px] font-black leading-tight text-gray-950 tracking-tight">
                Become a{" "}
              ...
              <p className="mt-1.5 sm:mt-2.5 text-xs sm:text-sm text-gray-600 font-normal leading-relaxed">
              ...
              <div className="mt-3 sm:mt-4 space-y-1.5 sm:space-y-2">
                <div className="flex items-center gap-2 text-[11.5px] sm:text-[13px] font-semibold text-gray-800">
            ...
            <div className="mt-4 sm:mt-6 pt-3 sm:pt-4 border-t border-gray-100 flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 sm:gap-3">
              <Link 
                href="/contact" 
                onClick={() => setOpen(false)}
                className="
