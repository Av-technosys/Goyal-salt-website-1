...
export const metadata = {
  title: "Annual Report | Goyal Salt Limited",
  description:
    "View the annual reports of Goyal Salt Limited with company details, yearly performance information and official records for easy reference.",
  alternates: {
    canonical: "https://goyalsaltltd.com/annual-report",
  },
};

const documents = [
  { title: "Annual-Report-2024", pdf: "/Brochure/Annual-Report-2024-6.pdf" },
  { title: "Annual-Report-2025", pdf: "/Brochure/GSL_Annual-Report_FY-2024-25.pdf" },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14">
          <h1 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-gray-900">
            Annual <span className="bg-gradient-to-r from-red-600 via-red-700 to-amber-600 bg-clip-text text-transparent">Reports</span>
          </h1>
