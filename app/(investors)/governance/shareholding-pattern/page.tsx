...
export const metadata = {
  title: "Shareholding Pattern | Goyal Salt Limited",
  description:
    "Understand the shareholding pattern of Goyal Salt Limited, with details of shareholders and ownership structure for transparency and public reference.",
  alternates: {
    canonical: "https://goyalsaltltd.com/governance/shareholding-pattern",
  },
};

const documents = [
  {
    title: "Shareholding Pattern as on March 31, 2025",
    pdf: "/Brochure/Shareholding-Pattern-Pattern-as-on-March-31-2025.pdf",
  },
  {
    title: "Shareholding Pattern as on September 30, 2024",
    pdf: "/Brochure/Shareholding-Pattern-as-on-September-30-2024-1.pdf",
  },
  {
    title: "Shareholding Pattern as on March 31, 2024",
    pdf: "/Brochure/Shareholding-Pattern-as-on-March-31-2024.pdf",
  },
  {
    title: "Shareholding Pattern as on September 30, 2025",
    pdf: "/Brochure/Shareholding-Pattern-as-on-September-30-2025.pdf",
  },
  {
    title: "Shareholding Pattern as on March 31, 2026",
    pdf: "/Brochure/Shareholding Pattern as on March 31, 2026.pdf",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14">
          <h1 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-gray-900">
            Shareholding <span className="bg-gradient-to-r from-red-600 via-red-700 to-amber-600 bg-clip-text text-transparent">Pattern</span>
          </h1>
