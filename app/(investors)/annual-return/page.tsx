...
export const metadata = {
  title: "Annual Return | Goyal Salt Limited",
  description:
    "View the annual return information of Goyal Salt Limited, including statutory filings, compliance details, and official company records for reference.",
  alternates: {
    canonical: "https://goyalsaltltd.com/annual-return",
  },
};

const documents = [
  { title: "Annual-Return-for-F.Y.-2023-24", pdf: "/Brochure/Annual-Return-for-F.Y.-2023-24.pdf" },
  { title: "Annual-Return-for-F.Y.-2024-25", pdf: "/Brochure/Annual-Return-for-F.Y.-2024-2025.pdf" },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14">
          <h1 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-gray-900">
            Annual <span className="bg-gradient-to-r from-red-600 via-red-700 to-amber-600 bg-clip-text text-transparent">Return</span>
          </h1>
