...
export const metadata = {
  title: "Q2 FY 2024–25 Investor Disclosures | Goyal Salt Limited   ",
  description:
    "Read Goyal Salt Limited’s Q2 FY 2024–25 investor disclosures, including quarterly highlights, financial reports, and regulatory compliance documents.",
  alternates: {
    canonical: "https://goyalsaltltd.com/listing-compliance/2024-25/q2",
  },
};
...
const documents = [
  {
    ...
    pdf: "/Brochure/Financial-Results-for-the-Half-Year-ended-30.09.2024-1-1.pdf",
  },
  {
    title:
      "Certificate under SEBI (Depositories and Participants) Regulations, 2018",
    pdf: "/Brochure/Certificate-under-SEBI-Depositories-and-Participants-Regulations-2018-1.pdf",
  },
  {
    title: "Non-Applicability of Regulation 27(2)",
    pdf: "/Brochure/Non-Applicability-of-Regulation-272-1.pdf",
  },
  {
  ...
  },
  {
    ...
    pdf: "/Brochure/SDD-Compliance-Certificate-1.pdf",
  },
  {
    title: "Statement of Grievance Redressal Mechanism under Regulation 13(3)",
    pdf: "/Brochure/Statement-of-Grievance-Redressal-Mechanism-under-Regulation-133-1.pdf",
  },
  {
    title: "Trading Window Closure for the period ended 30.09.2024",
    pdf: "/Brochure/Trading-Window-Closure-for-the-period-ended-30.09.2024.pdf",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14">
          <h1 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-gray-900">
            F.Y. 2024-25 - <span className="bg-gradient-to-r from-red-600 via-red-700 to-amber-600 bg-clip-text text-transparent">Quarter 2</span>
          </h1>
