...
export const metadata = {
  title: "Q1 FY 2025–26 Investor Disclosures | Goyal Salt Limited",
  description:
    "Check Goyal Salt Limited’s Q1 FY 2025–26 investor disclosures, quarterly highlights, financial results, and compliance documents for regulators and stakeholders.",
  alternates: {
    canonical: "https://goyalsaltltd.com/listing-compliance/2025-26/q1",
  },
};

const documents = [
  { title: "Integrated Governance Filing", pdf: "/Brochure/Integrated-Governance-Filing.pdf" },
  { title: "Intimation under Regulation 74(5)", pdf: "/Brochure/Intimation-under-Regulation-745.pdf" },
  { title: "Intimation under Regulation 76", pdf: "/Brochure/Intimation-under-Regulation-76.pdf" },
  { title: "Regulation 27_2_ Corporate Governance-NA", pdf: "/Brochure/Regulation-27_2_-Corporate-Governance-NA.pdf" },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14">
          <h1 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-gray-900">
            F.Y. 2025-26 - <span className="bg-gradient-to-r from-red-600 via-red-700 to-amber-600 bg-clip-text text-transparent">Quarter 1</span>
          </h1>
