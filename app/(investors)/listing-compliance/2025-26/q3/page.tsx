...
export const metadata = {
  title: "Q3 FY 2025–26 Investor Disclosures | Goyal Salt Limited",
  description:
    "Access Goyal Salt Limited’s Q3 FY 2025–26 investor disclosures, quarterly highlights, financial results, and compliance documents for regulators and stakeholders.",
  alternates: {
    canonical: "https://goyalsaltltd.com/listing-compliance/2025-26/q3",
  },
};

const documents = [
  { title: "Certificate under SEBI (Depositories and Participants) Regulations, 2018", pdf: "/Brochure/Certificate under SEBI (Depositories and Participants) Regulations, 2018.pdf" },
  { title: "Integarted FIiling-Governance", pdf: "/Brochure/Integarted FIiling-Governance.pdf" },
  { title: "Non-Applicability of Regulation 27(2)", pdf: "/Brochure/Non-Applicability of Regulation 27(2).pdf" },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14">
          <h1 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-gray-900">
            F.Y. 2025-26 - <span className="bg-gradient-to-r from-red-600 via-red-700 to-amber-600 bg-clip-text text-transparent">Quarter 3</span>
          </h1>
