...
export const metadata = {
  title: "Board Meetings Disclosure FY 2026–27 | Goyal Salt Limited  ",
  description:
    "Browse Goyal Salt Limited’s Board Meetings disclosure for FY 2026–27, including notices, outcomes, and regulatory filings for shareholder information. ",
  alternates: {
    canonical:
      "https://goyalsaltltd.com/notices-announcements/board-meetings-disclosure/2026-27",
  },
};
...
const documents = [
  ...
  {
    title: "Outcome of BM_18.06.2026",
    pdf: "/Brochure/Outcome of BM_18.06.2026.pdf",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14">
          <h1 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-gray-900">
            Board Meetings Disclosure <span className="bg-gradient-to-r from-red-600 via-red-700 to-amber-600 bg-clip-text text-transparent">F.Y. 2026–27</span>
          </h1>
