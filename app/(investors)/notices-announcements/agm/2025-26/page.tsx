...
export const metadata = {
  ...
  description:
    "View the Annual General Meeting (AGM) notices and official announcements for FY 2025–26 from Goyal Salt Limited, including shareholder information.",
  alternates: {
    canonical: "https://goyalsaltltd.com/notices-announcements/agm/2025-26",
  },
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14">
          <h1 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-gray-900">
            AGM <span className="bg-gradient-to-r from-red-600 via-red-700 to-amber-600 bg-clip-text text-transparent">F.Y. 2025–26</span>
          </h1>
